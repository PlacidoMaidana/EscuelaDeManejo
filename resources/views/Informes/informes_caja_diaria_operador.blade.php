...
<script>
  ...
  function filtrar() {
    ...
    var filtro_egr="{{url('/informe_cajadiaria_fecha_operador_egr/')}}"+"/"+$("#fecha").val()+'/'+{{$operador}};
    ...
    "columns":[
     ...
     var filtro_ing="{{url('/informe_cajadiaria_fecha_operador_ing/')}}"+"/"+$("#fecha").val()+'/'+{{$operador}};
...
var filtrototales ="{{url('/totales_caja_diaria/')}}"+"/"+$("#fecha").val()+'/'+{{$operador}};
console.log("El filtro del operador:  "+filtrototales);
...
<script>
   function excelExport()   {
    window.location.href = '/informes_tesoreria/caja_export/'+$("#fecha").val()+'/'+{{$operador}};
   }
</script>
@stop
